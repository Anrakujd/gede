(function e(t, n, r) {
    ...
    1: [function (require, module, exports) {
            ...
            AFRAME.registerComponent('super-hands', {
                schema: {
                    ...
                    grabStartButtons: {
                    default:
                        ['gripdown', 'trackpaddown', 'triggerdown', 'gripclose', 'pointup', 'thumbup', 'pointingstart', 'pistolstart', 'thumbstickdown', 'mousedown', 'touchstart']
                    },
                    grabEndButtons: {
                    default:
                        ['gripup', 'trackpadup', 'triggerup', 'gripopen', 'pointdown', 'thumbdown', 'pointingend', 'pistolend', 'thumbstickup', 'mouseup', 'touchend']
                    },
                    stretchStartButtons: {
                    default:
                        ['gripdown', 'trackpaddown', 'triggerdown', 'gripclose', 'pointup', 'thumbup', 'pointingstart', 'pistolstart', 'thumbstickdown', 'mousedown', 'touchstart']
                ...
                update: function (a) {
                    this.data.colliderState.length && console.warn('super-hands colliderState property is deprecated. Use colliderEndEvent/colliderEndEventProperty instead'),
                ...
                onGrabEndButton: function (a) {
                    ...
                    c && !this.emitCancelable(c, this.UNGRAB_EVENT, d) && (this.promoteHoveredEl(this.state.get(this.GRAB_EVENT)), this.state.delete(this.GRAB_EVENT), this.hover())
                },
                ...
                onStretchEndButton: function (a) {
                    ...
                    b && !this.emitCancelable(b, this.UNSTRETCH_EVENT, c) && (this.promoteHoveredEl(b), this.state.delete(this.STRETCH_EVENT), this.hover())
                },
                onDragDropStartButton: function (a) {
                    let b = this.state.get(this.DRAG_EVENT);
                    this.dragging = !0,
                    this.hoverEls.length && (this.gehDragged = new Set(this.hoverEls), this.dispatchMouseEventAll('dragstart', this.el)),
                ...
                onDragDropEndButton: function (a) {
                    ...
                    if (this.dragging = !1, this.gehDragged.forEach((a) => {
                        ...
                        e && (c.on = e, this.emitCancelable(b, this.DRAGDROP_EVENT, c), this._unHover(e)),
                        this.emitCancelable(b, this.UNDRAG_EVENT, d) || (this.promoteHoveredEl(b), this.state.delete(this.DRAG_EVENT), this.hover())
                    }
                },
                onHit: function (a) {
                    ...
                    var c = (a) => {
                        ...
                        -1 === b && (this.hoverEls.push(a), a.addEventListener('stateremoved', this.unWatch), this.dispatchMouseEvent(a, 'mouseover', this.el), this.dragging && this.gehDragged.size && this.gehDragged.forEach((a) => {
                ...
                hover: function () {
                    ...
                    this.dragging && this.state.get(this.DRAG_EVENT) && (a = {
                        ...
                        }, b = this.findTarget(this.DRAGOVER_EVENT, a, !0), b && (b.addEventListener('stateremoved', this.unHover), this.emitCancelable(this.state.get(this.DRAG_EVENT), this.DRAGOVER_EVENT, a), this.state.set(this.DRAGOVER_EVENT, b))),
                    this.state.has(this.DRAGOVER_EVENT) || (b = this.findTarget(this.HOVER_EVENT, {
                            hand: this.el
                        }, !0), b && (b.addEventListener('stateremoved', this.unHover), this.state.set(this.HOVER_EVENT, b)))
                },
                unHover: function (a) {
                    const b = a.detail[this.data.colliderEndEventProperty];
                    b ? Array.isArray(b) ? b.forEach((a) => this._unHover(a)) : this._unHover(b) : a.detail.state === this.data.colliderState && this._unHover(a.target)
                },
                _unHover: function (a, b) {
                    let c,
                    d = !1;
                    a.removeEventListener('stateremoved', this.unHover),
                    a === this.state.get(this.DRAGOVER_EVENT) && (this.state.delete(this.DRAGOVER_EVENT), d = !0, c = {
                            hand: this.el,
                            hovered: a,
                            carried: this.state.get(this.DRAG_EVENT)
                        }, this.emitCancelable(a, this.UNDRAGOVER_EVENT, c), this.state.has(this.DRAG_EVENT) && this.emitCancelable(this.state.get(this.DRAG_EVENT), this.UNDRAGOVER_EVENT, c)),
                    a === this.state.get(this.HOVER_EVENT) && (this.state.delete(this.HOVER_EVENT), d = !0, this.emitCancelable(a, this.UNHOVER_EVENT, {
                            hand: this.el
                        })),
                    d && !b && this.hover()
                },
                unWatch: function (a) {
                    const b = a.detail[this.data.colliderEndEventProperty];
                    b ? Array.isArray(b) ? b.forEach((a) => this._unWatch(a)) : this._unWatch(b) : a.detail.state === this.data.colliderState && this._unWatch(a.target)
                },
                _unWatch: function (a) {
                ...
                unRegisterListeners: function (a) {
                    a = a || this.data;
                    0 === Object.keys(a).length || (this.el.removeEventListener(a.colliderEvent, this.onHit), this.el.removeEventListener(a.colliderEndEvent, this.unHover), this.el.removeEventListener(a.colliderEndEvent, this.unWatch), a.grabStartButtons.forEach((a) => {
                ...
                dispatchMouseEventAll: function (a, b, c, d) {
                    let e = this.hoverEls;
                    if (c && (e = e.filter((a) => a !== this.state.get(this.GRAB_EVENT) && a !== this.state.get(this.DRAG_EVENT) && a !== this.state.get(this.STRETCH_EVENT) && !this.gehDragged.has(a))), d)
                        for (let c = 0; c < e.length; c++)
                            this.dispatchMouseEvent(e[c], a, b), this.dispatchMouseEvent(b, a, e[c]);
                    else
                        for (let c = 0; c < e.length; c++)
                ...
                findTarget: function (a, b, c) {
                    var d,
                    e = this.hoverEls;
                    for (c && (e = e.filter((a) => a !== this.state.get(this.GRAB_EVENT) && a !== this.state.get(this.DRAG_EVENT) && a !== this.state.get(this.STRETCH_EVENT))), d = e.length - 1; 0 <= d; d--)
    ...
    2: [function (require, module, exports) {
            ...
            AFRAME.registerComponent('locomotor-auto-config', {
                ...
                init: function () {
                    if (this.ready = !1, this.data.camera && !document.querySelector('a-camera, [camera]')) {
                ...
                update: function () {
                    this.el.getAttribute('stretchable') && !this.data.stretch ? (this.stretchSet = this.el.getAttribute('stretchable'), this.el.removeAttribute('stretchable')) : !this.el.getAttribute('stretchable') && this.data.stretch && this.el.setAttribute('stretchable', this.stretchSet),
                    this.el.getAttribute('grabbable') && !this.data.move ? (this.grabSet = this.el.getAttribute('grabbable'), this.el.removeAttribute('grabbable')) : !this.el.getAttribute('grabbable') && this.data.move && this.el.setAttribute('grabbable', this.grabSet)
                },
                remove: function () {
    ...
    3: [function (require, module, exports) {
            ...
            AFRAME.registerComponent('progressive-controls', {
                ...
                init: function () {
                    const a = AFRAME.components.link.schema.titleColor ? 'clearedEls' : 'el';
                    this.levels = ['gaze', 'point', 'touch'],
                    this.currentLevel = new Map,
                    this.controllerName = new Map;
                    const b = this.el.sceneEl.querySelector('a-assets') || this.el.sceneEl.appendChild(document.createElement('a-assets')),
                    ...
                    c.setAttribute('geometry', 'primitive: ring;radiusOuter: 0.008; radiusInner: 0.005; segmentsTheta: 32'),
                    ...
                    if (f.setAttribute('id', touchDefaultId), f.setAttribute('super-hands', ''), f.setAttribute('sphere-collider', ''), this.el.sceneEl.getAttribute('physics')) {
                    ...
                    ['left', 'right'].forEach((a) => {
                        this[a] = this.el.querySelector('.' + a + '-controller') || this.el.appendChild(document.createElement('a-entity'));
                        const b = {
                            hand: a,
                            model: this.data.controllerModel
                        };
                        ['daydream-controls', 'gearvr-controls', 'oculus-touch-controls', 'vive-controls', 'windows-motion-controls'].forEach((c) => this[a].setAttribute(c, b))
                    }),
                    this.el.addEventListener('controllerconnected', (a) => this.detectLevel(a)),
                ...
                setLevel: function (a, b, c) {
                    ...
                    if (a = a > d ? d : a, a !== this.currentLevel.get(b) || c) {
                        switch (0 !== a && this.caster && (this.caster.setAttribute('mixin', ''), this.camera.removeChild(this.caster), this.caster = null), a) {
                        case this.levels.indexOf('gaze'):
                            const c = this.data.gazeMixin;
                            this.caster.setAttribute('mixin', (f && c.length ? '' : gazeDefaultId + ' ') + c);
                            break;
                        case this.levels.indexOf('point'):
                            ...
                            e.setAttribute('mixin', (f && h.length ? '' : pointDefaultId + ' ') + h);
                            break;
                        case this.levels.indexOf('touch'):
                            const i = this.data.touchMixin;
                            e.setAttribute('mixin', (f && i.length ? '' : touchDefaultId + ' ') + i);
                        }
                ...
                detectLevel: function (a) {
                    ...
                    -1 === ['vive-controls', 'oculus-touch-controls', 'windows-motion-controls'].indexOf(a.detail.name) ? -1 !== ['gearvr-controls', 'daydream-controls'].indexOf(a.detail.name) && this.setLevel(this.levels.indexOf('point'), b) : this.setLevel(this.levels.indexOf('touch'), b)
                },
                eventRepeater: function (a) {
                    !this.caster || a.type.startsWith('touch') && (a.preventDefault(), 'touchmove' === a.type) || this.caster.emit(a.type, a.detail)
                },
    ...
    5: [function (require, module, exports) {
            ...
            AFRAME.registerComponent('clickable', AFRAME.utils.extendDeep({}, buttonCore, {
                    ...
                    start: function (a) {
                        this.startButtonOk(a) && (this.el.addState(this.CLICKED_STATE), -1 === this.clickers.indexOf(a.detail.hand) && (this.clickers.push(a.detail.hand), a.preventDefault && a.preventDefault()))
                    },
                    end: function (a) {
                        const b = this.clickers.indexOf(a.detail.hand);
                        this.endButtonOk(a) && (-1 !== b && this.clickers.splice(b, 1), 1 > this.clickers.length && this.el.removeState(this.CLICKED_STATE), a.preventDefault && a.preventDefault())
                    }
                }));
    ...
    6: [function (require, module, exports) {
            ...
            AFRAME.registerComponent('drag-droppable', inherit({}, buttonCore, {
                    ...
                    dragStart: function (a) {
                        this.startButtonOk(a) && (this.el.addState(this.DRAGGED_STATE), a.preventDefault && a.preventDefault())
                    },
                    hoverEnd: function () {
                        this.el.removeState(this.HOVERED_STATE)
                    },
                    dragEnd: function (a) {
                        this.endButtonOk(a) && (this.el.removeState(this.DRAGGED_STATE), a.preventDefault && a.preventDefault())
                    },
                    dragDrop: function (a) {
    ...
    8: [function (require, module, exports) {
            ...
            AFRAME.registerComponent('droppable', {
                ...
                hoverStart: function (a) {
                    this.entityAcceptable(a.detail.carried) && (this.el.addState(this.HOVERED_STATE), a.preventDefault && a.preventDefault())
                },
                hoverEnd: function () {
                    this.el.removeState(this.HOVERED_STATE)
                },
            ...
            AFRAME.registerComponent('grabbable', inherit({}, physicsCore, buttonsCore, {
                    ...
                    start: function (a) {
                        if (this.startButtonOk(a)) {
                            const b = !Number.isFinite(this.data.maxGrabbers) || this.grabbers.length < this.data.maxGrabbers;
                            if (-1 === this.grabbers.indexOf(a.detail.hand) && b) {
                                ...
                                this.physicsStart(a) || this.grabber || (this.grabber = a.detail.hand, this.resetGrabber()),
                                a.preventDefault && a.preventDefault(),
                                this.grabbed = !0,
                        ...
                        this.endButtonOk(a) && (-1 !== b && (this.grabbers.splice(b, 1), this.grabber = this.grabbers[0]), this.physicsEnd(a), !this.resetGrabber() && (this.grabbed = !1, this.el.removeState(this.GRABBED_STATE)), a.preventDefault && a.preventDefault())
                    },
                    resetGrabber: function () {
                        let a;
                        return !!this.grabber && (a = this.grabber.getAttribute('raycaster'), this.deltaPositionIsValid = !1, this.grabDistance = this.el.object3D.getWorldPosition().distanceTo(this.grabber.object3D.getWorldPosition()), a && (this.grabDirection = a.direction, this.grabOffset = a.origin), !0)
                    },
            ...
            module.exports = {
                ...
                physicsStart: function (a) {
                    if ('never' !== this.data.usePhysics && this.el.body && a.detail.hand.body && !this.constraints.has(a.detail.hand)) {
                        let b = new window.CANNON.LockConstraint(this.el.body, a.detail.hand.body);
                        return this.el.body.world.addConstraint(b),
                ...
                physicsEnd: function (a) {
                    ...
                    b && (this.el.body.world.removeConstraint(b), this.constraints.delete(a.detail.hand))
                },
    ...
    13: [function (require, module, exports) {
            ...
            AFRAME.registerComponent('stretchable', inherit({}, buttonCore, {
                    ...
                    tick: function () {
                        ...
                        let b = 1;
                        if (null !== this.previousStretch && 0 !== a && (b = Math.pow(a / this.previousStretch, this.data.invert ? -1 : 1)), this.previousStretch = a, this.scale.multiplyScalar(b), this.el.setAttribute('scale', this.scale), this.el.body && 'never' !== this.data.usePhysics) {
                            var c = this.el.body.shapes[0];
                            c.halfExtents ? (c.halfExtents.scale(b, c.halfExtents), c.updateConvexPolyhedronRepresentation()) : c.radius ? (c.radius *= b, c.updateBoundingSphereRadius()) : !this.shapeWarned && (console.warn('Unable to stretch physics body: unsupported shape'), this.shapeWarned = !0),
                    ...
                    start: function (a) {
                        this.stretched || this.stretchers.includes(a.detail.hand) || !this.startButtonOk(a) || (this.stretchers.push(a.detail.hand), 2 === this.stretchers.length && (this.stretched = !0, this.previousStretch = null, this.el.addState(this.STRETCHED_STATE)), a.preventDefault && a.preventDefault())
                    },
                    end: function (a) {
                        var b = this.stretchers.indexOf(a.detail.hand);
                        this.endButtonOk(a) && (-1 !== b && (this.stretchers.splice(b, 1), this.stretched = !1, this.el.removeState(this.STRETCHED_STATE)), a.preventDefault && a.preventDefault())
                    }
                }));
    ...
    14: [function (require, module, exports) {
            ...
            AFRAME.registerSystem('super-hands', {
                ...
                registerMe: function (a) {
                    1 === this.superHands.length && (this.superHands[0].otherSuperHand = a, a.otherSuperHand = this.superHands[0]),
